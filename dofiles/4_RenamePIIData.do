...
use13 "$rawdtaPII/merged/1_reformatted/reformatted_raw_merged_$date", clear
***************************************************
**2. Rename - Access
***************************************************
...
rename a_x a_est_6modate
rename a_y a_est_12modate
rename a_communicationnotes a_comnotes
rename a_monthcompleted a_2mo_done
rename a_ab a_6mo_done
rename a_ac a_12mo_done
...
rename b_Whatothertobaccoproductshave b_cigars
rename b_AB b_tobac_chew
rename b_AC b_tobac_dip
rename b_AD b_tobac_ecig
rename b_AE b_tobac_hookah
rename b_AF b_tobac_pipe
rename b_AG b_tobac_none
rename b_AH b_tobac_ra
rename b_AI b_tobac_other
...
rename b_Areyouseriouslythinkingofqu b_serious
...
save "$rawdtaPII\merged\2_renamed\renamed_raw_merged_$date", replace
